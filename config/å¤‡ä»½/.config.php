...
$_ENV['appName'] = 'mliao';							//站点名称
$_ENV['baseUrl'] = 'https://sp.juxing.xyz';					//站点地址
$_ENV['subUrl'] = $_ENV['baseUrl'] . '/link/';	//订阅地址，如需和站点名称相同，请不要修改
$_ENV['muKey'] = 'sp.juxing.xyz';								//用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
$_ENV['db_driver'] = 'mysql';							//数据库程序
$_ENV['db_host'] = 'localhost';						//数据库地址
$_ENV['db_database'] = 'sspanel';						//数据库名
$_ENV['db_username'] = 'sspanel';							//数据库用户名
$_ENV['db_password'] = 'ceTJ2issnte4bWGa';						//用户名对应的密码
...
#邮箱验证
$_ENV['enable_email_verify'] = true;		//是否启用注册邮箱验证码
...
//已注册用户设置---------------------------------------------------------------------------------------
#基础
$_ENV['checkinMin'] = 300;			//用户签到最少流量 单位MB
$_ENV['checkinMax'] = 1000;			//用户签到最多流量
